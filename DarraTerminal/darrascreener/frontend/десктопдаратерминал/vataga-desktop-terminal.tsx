...
import type { Bias, ScreenerAlert, ScreenerFrame, ServerMessage } from "@/lib/types";
import {
  alertSeverityClass,
...
function PaneRenderer({
  ...
  if (pane.widget === "signalTape") {
    return <SignalTapePane alerts={frame?.alerts ?? []} />;
  }
...
function SignalTapePane({ alerts }: { alerts: ScreenerAlert[] }) {
  return (
    <div className="flex h-full flex-col bg-[#1a1d2a]">
